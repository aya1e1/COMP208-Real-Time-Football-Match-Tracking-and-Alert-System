...
CREATE TABLE IF NOT EXISTS UserFavouriteTeams (
  ...
  CONSTRAINT FK_FavTeams_User FOREIGN KEY (UserID) REFERENCES Users(UserID) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS UserFavouritePlayers (
  ...
  CONSTRAINT FK_FavPlayers_User FOREIGN KEY (UserID) REFERENCES Users(UserID) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS UserNotificationPreferences (
  ...
  CONSTRAINT FK_UserPrefs_User FOREIGN KEY (UserID) REFERENCES Users(UserID) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS EventVotes (
  ...
  CONSTRAINT FK_EventVotes_User FOREIGN KEY (UserID) REFERENCES Users(UserID) ON DELETE CASCADE,
